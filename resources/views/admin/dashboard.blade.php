...
<body>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="{{ route('admin.deleteProduct', $product->id) }}" class="btn-delete" onclick="return confirm('Are you sure?')">Delete</a>
        </td>
    </tr>
@endforeach
        ...
        <div style="text-align: center; margin-top: 20px;">
            <a href="{{ url('/index') }}" class="btn-action">Home</a>
            <a href="{{ url('/home') }}" class="btn-action">Store</a>
            <a href="{{ route('admin.logout') }}" class="btn-action">Logout</a>
        </div>
    </div>
</body>
</html>
